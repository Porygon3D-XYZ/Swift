...
let somePlace = GPS(latitude: 51.1234, longitude: 0.1234)
print(somePlace)
...
var favoriteBook = Book(title: "Holden", author: "Thompson", pages: 234, price: 342)
...
var macbook = Laptop(yearPurchased: 2020)
var macbookPro = Laptop(screenSize: 16, repairCount: 1, yearPurchased: 2022)
...
var myHeight = Height(centimeters: 123)
print(myHeight)
