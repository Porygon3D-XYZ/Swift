...
var workout = RunningWorkout(distance: 12.12, time: 12.5, elevation: 145.1 )
workout.averageMileTime
/*:
...
var todaysStepGoal = Steps(steps: 1199, goal: 1200)
todaysStepGoal.takeStep()
/*:
